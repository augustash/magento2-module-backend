...
curl -Ss https://github.com/augustash/magento2-module-backend/archive/2.2.0.tar.gz | tar xf - --strip 1 -C app/code/Augustash/Backend/
...
composer require augustash/module-backend:~2.2.0
bin/magento module:enable --clear-static-content Augustash_Backend
bin/magento setup:upgrade
bin/magento cache:flush
```

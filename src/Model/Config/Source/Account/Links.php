...
class Links implements OptionSourceInterface
{
    ...
    public function toOptionArray(): array
    {
        ...
        $links = match ($this->productMetadata->getEdition()) {
            'Enterprise' => \array_merge($links, $this->getEnterpriseLinks()),
            'B2B' => \array_merge($links, $this->getEnterpriseLinks(), $this->getB2bLinks()),
            default => $links,
        };
        return $links;
    }
